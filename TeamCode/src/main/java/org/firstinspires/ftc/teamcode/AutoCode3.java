            ...
            switch (driveOpState) {
               ...
               */
                ...
                case FIRSTMOVE:
                    ...
                    break;
                case Rotate:
                    if ((Math.abs(chassis.zAngle - (originalRotation+initrotation)) >= 20)) {
                        chassis.SetMotors(0, 0, chassis.CorrectRotation(chassis.zAngle, (originalRotation+initrotation),0.04));
                        chassis.Drive();
                        chassis.SetAxisMovement();
                        chassis.ZeroEncoders();
                        chassis.SetAxisMovement();
