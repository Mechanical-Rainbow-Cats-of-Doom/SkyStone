...
public class DistanceSensorWithOpMode extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        DistanceSensorWithOpMode.OperState debugOpState = DistanceSensorWithOpMode.OperState.DEBUGSELECT;
        ...
        while (opModeIsActive()) {
            ...
            telemetry.addData("Ring Height", ring.RingHeight());
            telemetry.update();
